...
References
Anand, P., & Yadav, S. — Time-Series Forecasting Framework for Stock Market Prediction Using LSTM and Technical Indicators (2025)
Ampomah, E. K. et al. — Stock Market Decision Support Modeling with Tree-Based AdaBoost Ensemble Models (2021)
Wang, Y., & Wang, Z. — Stock Price Volatility Prediction Using XGBoost and ARIMA Models (2023)
Khaidem, L., Saha, S., & Dey, S. R. — Predicting Stock Market Direction Using Random Forest (2016)
Hu, Z., Zhao, Y., & Khushi, M. — Survey of Forex and Stock Price Prediction Using Deep Learning (2021)
